...
'''
CUDA_VISIBLE_DEVICES=0 python3 main.py --dataset_dir=man2baby
CUDA_VISIBLE_DEVICES=0 python3 main.py --dataset_dir=man2baby --phase=test --which_direction=AtoB
'''
